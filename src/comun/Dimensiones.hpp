...

{
    ...
    constexpr float MODULO_ANCHO_03_HP = 15.24f;
    constexpr float MODULO_ANCHO_04_HP = 20.32f;
    constexpr float MODULO_ANCHO_05_HP = 25.40f;
    constexpr float MODULO_ANCHO_06_HP = 30.48f;
    constexpr float MODULO_ANCHO_07_HP = 35.56f;
    constexpr float MODULO_ANCHO_08_HP = 40.64f;
